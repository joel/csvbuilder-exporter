  ...
  module Export
    RSpec.describe Attributes do
      ...
      describe "class" do
        ...
        it_behaves_like "defines_attributes_methods_safely", alpha: "alpha one", beta: "beta two"

        describe "::column" do
          it_behaves_like "column_method", Csvbuilder::Export, alpha: "alpha one", beta: "beta two"
        end
